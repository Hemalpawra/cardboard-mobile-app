import svgPaths from "./svg-hrz48zi9b6";
...
function Image() {
  return (
    <div className="absolute flex h-[136.506px] items-center justify-center left-[201px] top-[26px] w-[141.194px]">
...
function Image1() {
  return (
    <div className="absolute flex h-[97.541px] items-center justify-center left-[14.16px] top-[67.11px] w-[97.537px]">
...
function MainImage() {
  return (
    <div className="absolute flex h-[161.483px] items-center justify-center left-[91.93px] top-[56.45px] w-[142.854px]">
      <div className="flex-none rotate-[3.8deg]">
...
function AudioContainer() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[14px] overflow-x-auto overflow-y-clip rounded-[14px] top-[203.02px] w-[262px]" data-name="Audio Container">
      <AudioTextContainer />
    </div>
  );
}
...
function CommentsContainer() {
  return (
    <div className="flex-[1_0_0] min-h-px opacity-90 overflow-clip relative rounded-[12px] w-full" data-name="Comments container">
      <Image />
      <Image1 />
      <MainImage />
      <AudioContainer />
...
export default function Welcome() {
  return (
    <div className="bg-[#0d0d0f] content-stretch flex flex-col items-center justify-between overflow-clip relative rounded-[30px] size-full" data-name="Welcome">
