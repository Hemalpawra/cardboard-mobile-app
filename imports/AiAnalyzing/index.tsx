import svgPaths from "./svg-qt1dnj17s4";
...
function ChecklistItem() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Checklist Item">
      <div className="bg-[rgba(31,193,107,0.1)] relative rounded-[20px] shrink-0 size-[20px]" data-name="Icon">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#aeaeb5] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">Transcribing audio</p>
      </div>
    </div>
  );
}
...
function ChecklistItem1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Checklist Item">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#aeaeb5] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">Detecting speakers</p>
      </div>
    </div>
  );
}
...
function ChecklistItem2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Checklist Item">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#aeaeb5] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">Finding highlights</p>
      </div>
    </div>
  );
}
...
function ChecklistItem3() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Checklist Item">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#aeaeb5] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">Searching for B-roll</p>
      </div>
    </div>
  );
}
...
function ChecklistContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[28px] items-start relative shrink-0 w-full" data-name="Checklist Container">
      <ChecklistItem />
      <ChecklistItem1 />
      <ChecklistItem2 />
      <ChecklistItem3 />
...
function TitleContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[28px] items-start relative shrink-0 w-full" data-name="Title Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[32px] text-white w-full">
        <p className="leading-[44px] mb-0">Ai is analyzing</p>
        <p className="leading-[44px]">your video</p>
      </div>
      <ChecklistContainer />
    </div>
  );
...
function Form() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Form">
      <TitleContainer />
    </div>
  );
}
...
export default function AiAnalyzing() {
  return (
    <div className="bg-[#0d0d0f] content-stretch flex flex-col items-center justify-between overflow-clip relative rounded-[30px] size-full" data-name="Ai Analyzing">
