  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-[64px] px-[32px]">
        ...
        <button
          onClick={onAi}
          className="absolute left-1/2 bottom-[16px] -translate-x-1/2 flex items-center justify-center w-[64px] h-[64px] rounded-full bg-white border-[5px] border-[#0d0d0f] shadow-[0_0_20px_rgba(255,255,255,0.15)] active:scale-95 transition-transform cursor-pointer"
          aria-label="AI Assistant"
        >
          <svg className="w-[30px] h-[30px]" viewBox="0 0 30.0053 30.0067" fill="none">
