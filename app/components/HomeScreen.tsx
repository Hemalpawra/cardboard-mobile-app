  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-[64px] px-[32px]">
        ...
        <button
          onClick={onAi}
          className="absolute left-1/2 bottom-[16px] -translate-x-1/2 flex items-center justify-center w-[60px] h-[60px] rounded-full bg-white shadow-[0_4px_16px_rgba(255,255,255,0.2)] active:scale-95 transition-transform"
