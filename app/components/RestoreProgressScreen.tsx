...
export function RestoreProgressScreen({ onHome, onEdit }: Props) {
    ...
    <div className="absolute inset-0 flex flex-col bg-[#0D0D0F]">
      <AnimatePresence mode="wait">
        {!isDone ? (
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-center pt-[32px] pb-[40px] shrink-0">
            ...
            <div className="flex-1 flex flex-col justify-center items-center gap-[32px] pb-[80px]">
              ...
              <div className="flex flex-col items-center gap-[8px]">
                <span className="text-white text-[16px] font-medium">Restoring "Color graded"</span>
                <span className="text-[#7E7E8F] text-[13px] text-center px-[40px]">
                  Downloading assets from the cloud...
                </span>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex-1 flex flex-col items-center justify-center gap-[24px]">
              ...
              <div className="flex flex-col items-center gap-[8px]">
                <span className="text-white text-[24px] font-bold">Version Restored</span>
                <span className="text-[#7E7E8F] text-[14px]">Your project has been reverted.</span>
              </div>
            </div>
